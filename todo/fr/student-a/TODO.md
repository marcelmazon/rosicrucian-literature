# La vision etherique et ce qu'elle revele

### This was between chapters starting with:

"La vision éthérique révèle à la fois les molécules et les atomes, ainsi que les forces"

&

"Kékulé, qui a découvert l’anneau benzène"
...
### Put comments ending and starting with * right after corresponding chapter (in English do it too)


### All of this was after the paragraph
...
### These two paragraphs after the paragraph
...
(first one removed because found its place)
...
### This paragraph after the paragraph
...
# L'echelle musicale et le plan de l'évolution

### I think some musical chords tables don't correspond to the english version

### Entire foreword - right after table of contents and before chapter 1:
