...
A member reads aloud the following Rosicrucian Fellowship Service, beginning with the Rosicrucian Greeting:
...
After the concentration all rise and sing the last verse of the closing hymn.

Conclude the service by reading the following Parting Admonition:
